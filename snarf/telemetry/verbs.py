...
VERB_BY_SKILL: dict[str, str] = {
    ...
    "system_introspect": "mirando su propio catálogo",
    "os_audit": "auditando su propio repo",
    ...
    "second_brain_link_project": "vinculando el proyecto a Notion",
    ...
    "notion_move_page": "moviendo la página",
    "notion_create_database": "creando la database",
    "notion_update_page_cover": "cambiando la portada",
    "notion_update_page_icon": "cambiando el ícono",
    "notion_update_database_cover": "cambiando la portada de la database",
    "notion_update_database_icon": "cambiando el ícono de la database",
    "notion_archive_page": "archivando la página",
    "notion_restore_page": "restaurando la página",
    "second_brain_status": "revisando el Second Brain",
    "second_brain_list_areas": "listando las Áreas",
    "second_brain_get_area": "revisando el Área",
    "second_brain_list_projects": "listando los Proyectos",
    "second_brain_get_project": "revisando el Proyecto",
    "second_brain_list_resources": "listando los Recursos",
    "second_brain_list_archive": "revisando el Archivo",
    "second_brain_get_area_home": "armando el panorama del Área",
    "second_brain_area_report_refresh": "actualizando el reporte del Área",
    "second_brain_onboarding_auto_build": "construyendo tu Second Brain",
    "second_brain_onboarding_suggest_mapping": "buscando tus databases reales",
    "second_brain_onboarding_apply_mapping": "guardando el mapeo del Second Brain",
    "finance_supervisor_get_snapshot": "revisando el estado financiero",
    "finance_supervisor_set_sheet": "configurando la planilla de finanzas",
    "founder_mood_get_snapshot": "revisando cómo venís",
    # specialist_executive_board
    "executive_board_consult": "convocando al board",
    # specialist_executive_team
    "executive_team_run": "convocando al equipo",
    # specialist_document_writer
    "document_write_start": "arrancando el documento",
    "document_write_continue": "escribiendo la próxima sección",
    "document_write_status": "revisando el progreso del documento",
